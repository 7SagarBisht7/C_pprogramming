...
void searchcontact()
{
    ...
    while (another == 'y') {
        ...
        if (found > 1 && choice == 1) {
            printf("\n\nMultiple contacts found with the name '%s'", contactname);
            printf("\nEnter the phone number of the contact you want to view: ");
            scanf("%s", phonenumber);
            ...
            if (!found) {
                printf("\nNo contact found with name '%s' and phone number '%s'", contactname, phonenumber);
            }
        } else if (found == 0) {
            printf("\nNo contact found with %s '%s'", choice == 1 ? "name" : "phone number", choice == 1 ? contactname : phonenumber);
        }
